...
function initialize(a) {
	...
	if (a != 1) {
		...
		setTimeout(function() {
			if (settings.platform == "mobile") {
				try {
					document.body.removeEventListener('touchstart', handlePauseBefore, false);
				} catch (e) {
				...
				document.body.addEventListener('touchstart', handlePauseBefore, false);
			} else {
				try {
